...
jQuery(function($){
    ...
    // Temporary disabled, as doesn't work with Google Authenticator app.
    // login form
    $('#portal-personaltools a[href$="/login"], #portal-personaltools a[href$="/login_form"], .discussion a[href$="/login"], .discussion a[href$="/login_form"]').prepOverlay(
        {
            ...
            formselector: 'form#login_form, form.kssattr-formname-request-mobile-number-reset, form.kssattr-formname-google-authenticator-token',
